...
rptp=collect(collect(collect(collect(collect(collect(expand(modulo_vector(derivarv(rpt,u1))**2),xk*yk).subs(xk*yk,Ixy),xk*zk).subs(xk*zk,Ixz),yk*zk).subs(yk*zk,Iyz),xk**2).subs(xk**2,Ixx),yk**2).subs(yk**2,Iyy),zk**2).subs(zk**2,Izz)
