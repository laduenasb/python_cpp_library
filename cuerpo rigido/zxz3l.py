...
Ix=2.0
Iz=2.0
U=[u3, (2*Iz*u3*u5*u7**2*cos(u4) - (u3*cos(u4) + 3*u7**2)*(-2*Ix*u3*u5*cos(u4) + 2*Iz*u3*u5*cos(u4) + Iz*u5*u7**2 - g*m*xcm*cos(u2) + g*m*ycm*sin(u2)))*sin(u4)/(2*Iz*u7**2*cos(u4)**2 - (Ix*sin(u4)**2 + Iz*cos(u4)**2)*(u3*cos(u4) + 3*u7**2)), u5, (Ix*u3**2*sin(2*u4)/2 - Iz*u3**2*sin(2*u4)/2 - Iz*u3*u7**2*sin(u4) - g*m*xcm*sin(u1*u2)*cos(u4) - g*m*ycm*cos(u2)*cos(u4) + g*m*zcm*sin(u4))/Ix, u7, u7*(-Ix*u3*u5*cos(u4)**2 - Ix*u3*u5 + Iz*u3*u5*cos(u4)**2 + Iz*u5*u7**2*cos(u4) - g*m*xcm*cos(u2)*cos(u4) + g*m*ycm*sin(u2)*cos(u4))*sin(u4)/(2*Iz*u7**2*cos(u4)**2 - (Ix*sin(u4)**2 + Iz*cos(u4)**2)*(u3*cos(u4) + 3*u7**2))]
xa=0.0
xb=10.0
de=4
h=0.01
w=[0.2, 0.0, 0.5, 0.0, 0.1, 0.0]
def Runge_kutta_s2(U,w,xa,xb,de,h):
		...
		m=1.0
                ...
                Ix=2.0
                Iz=2.0
                f=(2*Iz*u3*u5*u7**2*cos(u4) - (u3*cos(u4) + 3*u7**2)*(-2*Ix*u3*u5*cos(u4) + 2*Iz*u3*u5*cos(u4) + Iz*u5*u7**2 - g*m*xcm*cos(u2) + g*m*ycm*sin(u2)))*sin(u4)/(2*Iz*u7**2*cos(u4)**2 - (Ix*sin(u4)**2 + Iz*cos(u4)**2)*(u3*cos(u4) + 3*u7**2))
                return f
		...
		m=1.0
                ...
                Ix=2.0
                Iz=2.0
                f=(Ix*u3**2*sin(2*u4)/2 - Iz*u3**2*sin(2*u4)/2 - Iz*u3*u7**2*sin(u4) - g*m*xcm*sin(u1*u2)*cos(u4) - g*m*ycm*cos(u2)*cos(u4) + g*m*zcm*sin(u4))/Ix
                return f
		...
		m=1.0
                ...
                Ix=2.0
                Iz=2.0
                f=u7*(-Ix*u3*u5*cos(u4)**2 - Ix*u3*u5 + Iz*u3*u5*cos(u4)**2 + Iz*u5*u7**2*cos(u4) - g*m*xcm*cos(u2)*cos(u4) + g*m*ycm*sin(u2)*cos(u4))*sin(u4)/(2*Iz*u7**2*cos(u4)**2 - (Ix*sin(u4)**2 + Iz*cos(u4)**2)*(u3*cos(u4) + 3*u7**2))
                return f
