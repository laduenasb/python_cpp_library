...
from math import *
U=['u3', '((Ixx*((cos(u2)-1.0)**2.0+(sin(u4)**2.0)*(sin(u2)**2.0))+Izz*(sin(u2)**2.0)+Ixz*sin(u2)*cos(u4)*(cos(u2)-1.0))*((m*g*xcm*cos(u4)*cos(u2)+m*g*ycm*sin(u4)*cos(u2)+m*g*zcm*sin(u2))-(-2.0*Ixx*cos(u4)*sin(u4)*u5)*u3-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u5+0.5*(u5**2.0)*(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2))+2.0*Izz*sin(u2)*cos(u2)+Ixz*(cos(u4)*(cos(u2)*(cos(u2)-1.0)-sin(u2)*sin(u2))))+0.5*u5*u3*(-Ixx*sin(2.0*u4)*cos(u2)-Ixz*sin(u4)*sin(u2)))-0.5*((-m*g*xcm*sin(u4)*sin(u2)+m*g*ycm*cos(u4)*sin(u2))-(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)*u3+2.0*sin(u4)*cos(u4)*u5*(sin(u2)**2.0)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2)*u3)+2.0*Izz*sin(u2)*cos(u2)*u3+Ixz*(cos(u2)*u3*cos(u4)*(cos(u2)-1.0)+sin(u2)*(-sin(u4)*u5*(cos(u2)-1.0)-cos(u4)*sin(u2)*u3)))*u5-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u3+0.5*(u5**2.0)*(Ixx*(2.0*sin(u4)*cos(u4)*(sin(u2)**2.0))-Ixz*sin(u2)*sin(u4)*(cos(u2)-1.0))+0.5*(u3**2.0)*(-2.0*Ixx*sin(u4)*cos(u4))+0.5*u5*u3*(-2.0*Ixx*cos(2.0*u4)*sin(u2)+Ixz*cos(u4)*(cos(u2)-1.0)))*(-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0)))/((Ixx*((cos(u2)-1.0)**2.0+(sin(u4)**2.0)*(sin(u2)**2.0))+Izz*(sin(u2)**2.0)+Ixz*sin(u2)*cos(u4)*(cos(u2)-1.0))*(Ixx*(cos(u4)**2.0)+Izz)-(1.0/4.0)*((-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0))**2.0))', 'u5', '(((-m*g*xcm*sin(u4)*sin(u2)+m*g*ycm*cos(u4)*sin(u2))-(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)*u3+2.0*sin(u4)*cos(u4)*u5*(sin(u2)**2.0)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2)*u3)+2.0*Izz*sin(u2)*cos(u2)*u3+Ixz*(cos(u2)*u3*cos(u4)*(cos(u2)-1.0)+sin(u2)*(-sin(u4)*u5*(cos(u2)-1.0)-cos(u4)*sin(u2)*u3)))*u5-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u3+0.5*(u5**2.0)*(Ixx*(2.0*sin(u4)*cos(u4)*(sin(u2)**2.0))-Ixz*sin(u2)*sin(u4)*(cos(u2)-1.0))+0.5*(u3**2.0)*(-2.0*Ixx*sin(u4)*cos(u4))+0.5*u5*u3*(-2.0*Ixx*cos(2.0*u4)*sin(u2)+Ixz*cos(u4)*(cos(u2)-1.0)))*(Ixx*(cos(u4)**2.0)+Izz)-0.5*(-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0))*((m*g*xcm*cos(u4)*cos(u2)+m*g*ycm*sin(u4)*cos(u2)+m*g*zcm*sin(u2))-(-2.0*Ixx*cos(u4)*sin(u4)*u5)*u3-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u5+0.5*(u5**2.0)*(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2))+2.0*Izz*sin(u2)*cos(u2)+Ixz*(cos(u4)*(cos(u2)*(cos(u2)-1.0)-sin(u2)*sin(u2))))+0.5*u5*u3*(-Ixx*sin(2.0*u4)*cos(u2)-Ixz*sin(u4)*sin(u2))))/((Ixx*((cos(u2)-1.0)**2.0+(sin(u4)**2.0)*(sin(u2)**2.0))+Izz*(sin(u2)**2.0)+Ixz*sin(u2)*cos(u4)*(cos(u2)-1.0))*(Ixx*(cos(u4)**2.0)+Izz)-(1.0/4.0)*((-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0))**2.0))']
xa=0.0
xb=10.0
de=4
h=1e-2
w=[pi/2.0, 0.0,0.0, 0.1]
def Runge_kutta_s2(U,w,xa,xb,de,h):
	...
	def crear_vector(xa,xb,k):   #xa y xb el intervalo con xa<xb, y k la cantidad de puntos
        ...
        ycm=0.0
        zcm=1/(2**0.5)
        xk=[xcm*cos(w[0])+zcm*sin(w[0])]
        yk=[ycm]
        zk=[-xcm*sin(w[0])+zcm*cos(w[0])]
        r=[4.0]
        h_new=[]
        error=10**(-de-1)
        ...
        def funcion2(u1,u2,u3,u4,u5):
                ...
                Izz=0.5
                Ixz=0.5                
                f=((Ixx*((cos(u2)-1.0)**2.0+(sin(u4)**2.0)*(sin(u2)**2.0))+Izz*(sin(u2)**2.0)+Ixz*sin(u2)*cos(u4)*(cos(u2)-1.0))*((m*g*xcm*cos(u4)*cos(u2)+m*g*ycm*sin(u4)*cos(u2)+m*g*zcm*sin(u2))-(-2.0*Ixx*cos(u4)*sin(u4)*u5)*u3-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u5+0.5*(u5**2.0)*(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2))+2.0*Izz*sin(u2)*cos(u2)+Ixz*(cos(u4)*(cos(u2)*(cos(u2)-1.0)-sin(u2)*sin(u2))))+0.5*u5*u3*(-Ixx*sin(2.0*u4)*cos(u2)-Ixz*sin(u4)*sin(u2)))-0.5*((-m*g*xcm*sin(u4)*sin(u2)+m*g*ycm*cos(u4)*sin(u2))-(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)*u3+2.0*sin(u4)*cos(u4)*u5*(sin(u2)**2.0)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2)*u3)+2.0*Izz*sin(u2)*cos(u2)*u3+Ixz*(cos(u2)*u3*cos(u4)*(cos(u2)-1.0)+sin(u2)*(-sin(u4)*u5*(cos(u2)-1.0)-cos(u4)*sin(u2)*u3)))*u5-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u3+0.5*(u5**2.0)*(Ixx*(2.0*sin(u4)*cos(u4)*(sin(u2)**2.0))-Ixz*sin(u2)*sin(u4)*(cos(u2)-1.0))+0.5*(u3**2.0)*(-2.0*Ixx*sin(u4)*cos(u4))+0.5*u5*u3*(-2.0*Ixx*cos(2.0*u4)*sin(u2)+Ixz*cos(u4)*(cos(u2)-1.0)))*(-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0)))/((Ixx*((cos(u2)-1.0)**2.0+(sin(u4)**2.0)*(sin(u2)**2.0))+Izz*(sin(u2)**2.0)+Ixz*sin(u2)*cos(u4)*(cos(u2)-1.0))*(Ixx*(cos(u4)**2.0)+Izz)-(1.0/4.0)*((-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0))**2.0))                
                return f
        ...
        def funcion4(u1,u2,u3,u4,u5):
                ...
                Izz=0.5
                Ixz=0.5
                f=(((-m*g*xcm*sin(u4)*sin(u2)+m*g*ycm*cos(u4)*sin(u2))-(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)*u3+2.0*sin(u4)*cos(u4)*u5*(sin(u2)**2.0)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2)*u3)+2.0*Izz*sin(u2)*cos(u2)*u3+Ixz*(cos(u2)*u3*cos(u4)*(cos(u2)-1.0)+sin(u2)*(-sin(u4)*u5*(cos(u2)-1.0)-cos(u4)*sin(u2)*u3)))*u5-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u3+0.5*(u5**2.0)*(Ixx*(2.0*sin(u4)*cos(u4)*(sin(u2)**2.0))-Ixz*sin(u2)*sin(u4)*(cos(u2)-1.0))+0.5*(u3**2.0)*(-2.0*Ixx*sin(u4)*cos(u4))+0.5*u5*u3*(-2.0*Ixx*cos(2.0*u4)*sin(u2)+Ixz*cos(u4)*(cos(u2)-1.0)))*(Ixx*(cos(u4)**2.0)+Izz)-0.5*(-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0))*((m*g*xcm*cos(u4)*cos(u2)+m*g*ycm*sin(u4)*cos(u2)+m*g*zcm*sin(u2))-(-2.0*Ixx*cos(u4)*sin(u4)*u5)*u3-0.5*(-Ixx*(2.0*cos(2.0*u4)*u5*sin(u2)+sin(2.0*u4)*cos(u2)*u3)+Ixz*(cos(u4)*u5*(cos(u2)-1.0)-sin(u4)*sin(u2)*u3))*u5+0.5*(u5**2.0)*(Ixx*(-2.0*(cos(u2)-1.0)*sin(u2)+2.0*(sin(u4)**2.0)*sin(u2)*cos(u2))+2.0*Izz*sin(u2)*cos(u2)+Ixz*(cos(u4)*(cos(u2)*(cos(u2)-1.0)-sin(u2)*sin(u2))))+0.5*u5*u3*(-Ixx*sin(2.0*u4)*cos(u2)-Ixz*sin(u4)*sin(u2))))/((Ixx*((cos(u2)-1.0)**2.0+(sin(u4)**2.0)*(sin(u2)**2.0))+Izz*(sin(u2)**2.0)+Ixz*sin(u2)*cos(u4)*(cos(u2)-1.0))*(Ixx*(cos(u4)**2.0)+Izz)-(1.0/4.0)*((-Ixx*sin(2.0*u4)*sin(u2)+Ixz*sin(u4)*(cos(u2)-1.0))**2.0))
                return f
		...
		W1[i][3]=w1[3]
		xk.append(xcm*(sin(w1[2])**2.0+cos(w1[0])*cos(w1[2])**2.0)+ycm*(sin(w1[2])*cos(w1[2])*(cos(w1[0])-1.0))+zcm*(sin(w1[0])*cos(w1[2])))
		yk.append(xcm*(sin(w1[2])*cos(w1[2])*(cos(w1[0])-1.0))+ycm*(cos(w1[2])**2.0+cos(w1[0])*sin(w1[2])**2.0)+zcm*(sin(w1[0])*sin(w1[2])))
		zk.append(-xcm*(cos(w1[2])*sin(w1[0]))-ycm*(sin(w1[2])*sin(w1[0]))+zcm*cos(w1[0]))
		r.append(sqrt(xk[i]**2.0+yk[i]**2.0+zk[i]**2.0))
...
#        print hkl
        ...
        if len(h_new)==0:
                h_new.append(h)
        return vector_t,W1,h,minimo(h_new),xk,yk,zk,r
